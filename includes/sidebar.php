<!-- Sidebar Navigation (Simple & Elegant Bootstrap List Group) -->
<div class="card mb-4 shadow-sm">
    <div class="list-group list-group-flush">
        <a href="<?= BASE_URL ?>index.php" class="list-group-item list-group-item-action d-flex align-items-center gap-2 py-2.5">
            <i class="bi bi-speedometer2 text-secondary"></i> Home Dashboard
        </a>
        ...
        <a href="<?= BASE_URL ?>modules/reservasi/riwayat.php" class="list-group-item list-group-item-action d-flex align-items-center gap-2 py-2.5">
            <i class="bi bi-calendar3 text-secondary"></i> Booking History
        </a>
    </div>
</div>