                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <?php endif; ?>
                                            <a href="./update.php?id_reserv=<?= $data['id_reserv'] ?>" class="btn btn-outline-secondary btn-sm" title="edit" style="padding-bottom: 4px; padding-top: 4px;">
                                            ...
                                            <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');" href="./delete.php?id_reserv=<?= $data['id_reserv'] ?>" class="btn btn-outline-danger btn-sm" title="delete" style="padding-bottom: 4px; padding-top: 4px;">
